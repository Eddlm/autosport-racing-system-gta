...
- **`SET_DRIVE_TASK_DRIVING_STYLE` (`0x27be5555cdf6f983`) takes the `DF_` bitfield, not the 0/1/2 style** — it ends at `SetAllFlags(flags)` (`TaskVehicleMissionBase.h:293`).
